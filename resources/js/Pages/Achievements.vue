<template>
    ...
    <div class="text-lg font-semibold bg-sepia-300 py-5 px-5 lg:ml-10 lg:mr-10 rounded">
        <p class="mt-20">WorkHub was Created in 2008 to bring salary transparency and hones company reviews to millions of current and prospective employees. Today, WorkHub
            boost 1.3 million employers in the database, 70 million company reviews and insights, and 9 million joblistings. Job seekers can simultaneously
            search for open jobs and read detailed information on each company's culture, CEO, benefits, and salary data, making WorkHub the clear winner for employer
